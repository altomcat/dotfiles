...
awful.screen.connect_for_each_screen(function(s)
      ...
      -- Override layout for tag 
      local screen = awful.screen.focused()
      awful.layout.set(awful.layout.suit.corner.nw, screen.tags[3])
      awful.layout.set(awful.layout.suit.max.fullscreen, screen.tags[8])
...
globalkeys = gears.table.join(
   ...
   -- screenshot
   awful.key({}, "Print",
      function () awful.spawn.with_shell("scrot -e 'mv $f ~/Pictures/Screenshots'") end,
      {description = "Screenshot", group = "Screenshot"}),
   awful.key({control}, "Print",
      function () awful.spawn.with_shell("scrot -s -e 'mv $f ~/Pictures/Screenshots'") end,
      {description = "Screenshot (area selection)", group = "Screenshot"}),
   awful.key({shift}, "Print",
      function () awful.spawn.with_shell("scrot -d3 -e 'mv $f ~/Pictures/Screenshots'") end,
   ...
   awful.key({modkey, "Control"}, "e",
      function () awful.spawn.with_shell("emacsclient -c -n") end,
      {description = "Emacs 28.1", group = "Apps"}),
